...
class ULCDiscord {
    ...
    /**
     *  @return l'instance du client discord
     */
    public static function client() {
        if (ULCDiscord::$client == NULL) {
            ULCDiscord::$client = new DiscordClient(['token' => ULCDiscord::botToken()]);
        }
        return (ULCDiscord::$client);
    }

    /**
     *  @return le token du bot
     */
    ...
    /**
     *  @return l'instance de la guilde du client Discord
     */
